...
CorrectUsername = "sardaar876"
CorrectPassword = "sardaar887766"
...
while (loop == 'true'):
    ...
    if (username == CorrectUsername):
        ...
        if (password == CorrectPassword):
            print "Logged in successfully as " + username #umrani:baloch_um
	    time.sleep(2)
            loop = 'false'
        else:
